...
\begin{figure}[H]
\centering
\subfigure[Image Originale]{\label{fig:oval} \includegraphics[width=0.4\textwidth]{figures/oval_petit.png}}
\subfigure[Image reconstruite - patch taille 13 - 14 sec]{\label{fig:ovalb} \includegraphics[width=0.4\textwidth]{figures/resultOval9.png}}
...
\subfigure[Photo restaurée]{\label{fig:lincolnb} \includegraphics[width=0.4\textwidth]{figures/resultLinc5.png}}
